...
object TenantAiConfigs : Table("titlis_oltp.tenant_ai_configs") {
    ...
    val githubAuthMode          = text("github_auth_mode").default("pat")
    val githubAppIdEnc          = text("github_app_id_enc").nullable()
    val githubAppPrivKeyEnc     = text("github_app_priv_key_enc").nullable()
    val githubAppInstallIdEnc   = text("github_app_install_id_enc").nullable()
