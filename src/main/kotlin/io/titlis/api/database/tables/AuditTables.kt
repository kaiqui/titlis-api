...
object AppScorecardHistory : Table("titlis_audit.app_scorecard_history") {
    ...
    val pillarScores          = jsonbText("pillar_scores")        // [{pillar, score, passed_checks, failed_checks, weighted_score}]
    val validationResults     = jsonbText("validation_results")   // [{rule_ref, pillar, severity, passed, message, actual_value}]
...
object RemediationHistory : Table("titlis_audit.remediation_history") {
    ...
    val scorecardVersion              = integer("scorecard_version").nullable()
    ...
    val issuesSnapshot                = jsonbText("issues_snapshot").nullable()
